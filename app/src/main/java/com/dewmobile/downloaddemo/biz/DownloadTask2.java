...
public class DownloadTask2 implements Runnable {
    ...
    protected void notifyStatusChanged() {
        DownloadManager.getInstance().getDownloadBroadHelper().notifyDownloadStatusChanged(null, downloadStatus);
    }

    protected void notifyProgressChanged(long currentSize, long totalSize) {
        DownloadManager.getInstance().getDownloadBroadHelper().notifyProgressChanged(null, currentSize, totalSize);
    }
